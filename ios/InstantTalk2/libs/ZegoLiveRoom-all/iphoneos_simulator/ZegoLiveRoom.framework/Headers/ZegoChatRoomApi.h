...
/**
 ...
 @attention 使用聊天室功能，初始化相关视图控制器时需要设置代理对象
...
/**
 ...
 @param block 登录聊天室回调
 @return true 成功，false 失败
 @attention 登录聊天室前，需调用 [ZegoLiveRoomApi +setUserID:userName:] 设置用户 UserID 和 UserName 成功
...
{
    Disconnected = 1,       /**< 连接断开 */
    WaitingConnect,         /**< 网络切换时，网络状态为WaitingConnect，网络恢复时，会自动重连 */
    Connecting,             /**< 连接中 */
    Connected,              /**< 已连接 */
};
